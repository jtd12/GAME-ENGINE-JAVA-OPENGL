...
public void renderScene(List<roues> roues_,List<roues> roues2_,List<player> p,List<entity> entities, List<terrain> terrains, light lights,
...
public void renderShadowMap(List<entity> entityList,List<player> p,light sun)
